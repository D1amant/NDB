...
+ function(a) {
	...
	b.DEFAULTS = {
		...
		void 0 : this.sliding ? this.$element.one("slid", function() {
			c.to(b)
	...
	b.DEFAULTS = {
		...
		void 0 : (d.removeClass("in"), a.support.transition && this.$tip.hasClass("fade") ? d.one(a.support.transition.end, b).emulateTransitionEnd(150) : b(), this.$element.trigger("hidden.bs." + this.type), this)
