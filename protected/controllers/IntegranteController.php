	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Integrante']))
		{
			$model->attributes = $_POST['Integrante'];
			    ...
			    $uploadFile = CUploadedFile::getInstance($model, 'imagem');
				$fileName = "{$uploadFile}";
				$model->imagem = 'images/upload/'.$fileName;
				if(isset($uploadFile))
				{
			 ...
			 if($model->save())
				$this->redirect(array('view','id'=>$model->idintegrante));
		}
